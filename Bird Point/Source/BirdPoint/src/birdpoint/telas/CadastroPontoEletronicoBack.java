...
public class CadastroPontoEletronicoBack extends javax.swing.JDialog {
    ...
    public CadastroPontoEletronicoBack(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public void abrirTelaMensagemPonto(Ponto ponto) {
        ...
        new MensagemPonto(null, true, ponto.getProfessor(), entradaOuSaida, carregarTurno()).setVisible(true);
    }
...
//este método deve preencher a lista de codigo de professores sem que eles se repitam
    ...
    private void telaMensagemPonto(Professor professor, String verificarEntradaOuSaida) {
        new MensagemPonto(null, rootPaneCheckingEnabled, professor, verificarEntradaOuSaida, carregarTurno()).setVisible(true);
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CadastroPontoEletronicoBack.class
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                CadastroPontoEletronicoBack dialog = new CadastroPontoEletronicoBack(new javax.swing.JFrame(), true);
